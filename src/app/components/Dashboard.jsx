...
export default function Dashboard() {
  ...
  return (
    <main className="bg-gray-100 dark:bg-slate-900 p-3 md:p-6 lg:p-8 min-h-screen">
...
{/* Card Top  */}
      ...
      {/* FIlter and stat */}
        <div className="bg-white p-3 dark:bg-slate-800 dark:border-slate-700 md:p-5 rounded-lg shadow-md border border-gray-200 space-y-4">
